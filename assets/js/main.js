...
function _(id) { return document.getElementsById(id); }
function submitForm(){
  _id("submit").disabled=true;
  _id("submit").innerHTML = 'Please wait....';
  ...
  ajax.onreadystatechangev = function(){
    if (ajax.responseState == 4 && ajax.status ==200){
      if (ajax.responseText == "success"){
        _("php-email-form").innerHTML = '<h2>Thanks'+_("name").value+',your message has been sent.</h2>'
      }
      else{
        _("submit").innerHTML = ajax.responseText;
